...
few_shots_file = "all_few_shots.json"
cxDocFile = "doc.json"

devFlag = os.environ.get("DEV")
if devFlag == 'True':
    few_shots_file = "all_few_shots_dev.json"
    cxDocFile = "doc_dev.json"

params_set = set()
few_shots_set = read_json_file(few_shots_file)
few_shots_set = few_shots_set['examples']
for curRec in few_shots_set:
