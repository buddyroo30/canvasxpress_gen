...
To build and run the development version of the application there are Makefile targets for all the above corresponding to those by simply appending '_dev' (i.e. 'make build_dev', 'make run_dev', 'make exit_dev', etc.)
